// src/app/concept-wise/[slug]/page.tsx
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${post.title} | Concept Wise | Phyziks.space`,
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-3">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <Link href="/concept-wise" className="text-gray-600 hover:text-blue-600">Concept Wise</Link>
            <ChevronRight className="w-4 h-4 text-gray-400" />
      ...
      <article className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <header className="bg-white rounded-lg shadow-md p-8 mb-8">
          <div className="flex items-center gap-2 mb-4">
            <span className="inline-block px-3 py-1 text-sm font-semibold text-orange-600 bg-orange-100 rounded-full flex items-center gap-1">
        ...
        {post.concepts && post.concepts.length > 0 && (
          <div className="bg-gradient-to-r from-orange-50 to-orange-100 border-l-4 border-orange-500 rounded-r-lg p-6 mb-8">
            <h3 className="font-semibold text-orange-900 mb-3 flex items-center gap-2 text-lg">
            ...
            <div className="flex flex-wrap gap-2">
              {post.concepts.map((concept) => (
                <span 
                  key={concept}
                  className="px-4 py-2 bg-white text-orange-700 rounded-lg font-medium shadow-sm"
                >
                  {concept}
                </span>
              ))}
        ...
        {/* Related Information */}
        {(post.chapters || post.topics) && (
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-900">Related Information</h2>
        ...
        <div className="bg-blue-50 border-l-4 border-blue-500 rounded-r-lg p-6 mb-8">
          ...
          <p className="text-blue-800 text-sm">
            To master this concept, try explaining it to someone else in your own words. 
            This helps reinforce your understanding and identify any gaps in your knowledge.
          </p>
        </div>
