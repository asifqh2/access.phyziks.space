...
export default async function TopicDetailPage({ params }: Props) {
  ...
  if (!(await canCurrentUserAccessContent(post.requiredPlan))) {
    return <main className="min-h-screen bg-gray-50 px-4 py-16"><div className="mx-auto max-w-xl rounded-2xl bg-white p-8 text-center shadow-lg"><h1 className="text-2xl font-bold text-gray-900">Paid access required</h1><p className="mt-3 text-gray-600">This topic requires the {post.requiredPlan} plan.</p><Link href="/pricing" className="mt-6 inline-block rounded-lg bg-indigo-600 px-5 py-3 font-semibold text-white">View plans</Link></div></main>;
  }
